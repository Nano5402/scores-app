  ...
  return (
    <div className="space-y-6 animate-fade-up pb-24">
      ...
      <div>
        ...
        <div className="card overflow-hidden">
          ...
          <Link to="/forgot-password">
            <SettingRow icon={KeyRound} label="Cambiar contraseña"
              description="Actualiza tu contraseña" last>
              <ChevronRight className="w-4 h-4 shrink-0" style={{ color: 'var(--text-muted)' }} />
            </SettingRow>
          </Link>
        </div>
      ...
      <div>
        ...
        <div className="card overflow-hidden">
          <SettingRow icon={Moon} label="Modo oscuro"
            description={darkMode ? 'Activo — fondo negro OLED' : 'Inactivo — fondo claro'} last>
      ...
      <div>
        ...
        <div className="card overflow-hidden">
          <SettingRow icon={Bell} label="Notificaciones push"
            description="Recibir avisos del club">
            <ToggleSwitch
              value={notifications.push}
              onChange={(v) => setNotification('push', v)}
            />
          </SettingRow>
          <SettingRow icon={Bell} label="Partidos en vivo"
          ...
          <SettingRow icon={Bell} label="Resultados"
            description="Al finalizar un partido" last>
            <ToggleSwitch
      ...
      <div>
        ...
        <div className="card overflow-hidden">
          <SettingRow icon={Shield} label="Seguridad"
            description="Autenticación y sesiones activas" last>
            <ChevronRight className="w-4 h-4 shrink-0" style={{ color: 'var(--text-muted)' }} />
          </SettingRow>
        </div>
      </div>
