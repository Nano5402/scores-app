      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
        ...
        <div className="form-group">
          ...
          <div className="flex gap-2">
            <div className="flex items-center justify-center px-3 rounded-lg text-xs font-bold shrink-0"
              style={{ backgroundColor: 'var(--color-brand-dim)', color: 'var(--color-brand)', border: '1px solid var(--border-color)' }}>
              CC
            </div>
