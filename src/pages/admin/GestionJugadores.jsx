  ...
  return (
    <div className="space-y-6 animate-fade-up">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold" style={{ color: 'var(--text-primary)' }}>Jugadores</h1>
      ...
      {showForm && (
        <div className="card p-5 animate-fade-up">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Input label="Apodo" placeholder="El Zurdo"
              {...register('apodo')} />
            ...
            <Input label="Altura (cm)" type="number" placeholder="175"
              {...register('altura_cm')} />
            ...
            <div key={j.id} className="list-row"
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold" style={{ color: 'var(--text-primary)' }}>
                  {j.nombre} {j.apellido}
                  {j.apodo && <span className="ml-2 text-xs font-normal" style={{ color: 'var(--text-muted)' }}>"{j.apodo}"</span>}
                </p>
                <div className="flex items-center gap-2 mt-0.5">
                  <span className={j.deporte === 'tenis' ? 'badge-atp' : j.deporte === 'padel' ? 'badge-padel' : 'badge-brand'}>
                    {j.deporte}
                  </span>
                  {j.categoria && (
              ...
              <div className="flex items-center gap-1 shrink-0">
                ...
                <button onClick={() => handleDelete(j)} className="btn-ghost p-2"
                  style={{ color: '#ef4444' }}>
