...
export default function GestionCategorias() {
  ...
  const filtered = tab === 'todos'
    ? categorias
    : categorias.filter((c) => c.deporte === tab)
      ...
      <div className="card overflow-hidden">
        {loading ? (
          Array(5).fill(0).map((_, i) => (
            <div key={i} className="skeleton h-12 m-3 rounded-lg" />
          ))
        ) : filtered.length === 0 ? (
          ...
          filtered
            ...
            .map((cat, i, arr) => (
              ...
              >
                ...
                <span className={cat.deporte === 'tenis' ? 'badge-atp' : cat.deporte === 'padel' ? 'badge-padel' : 'badge-brand'}>
                  {cat.deporte}
                </span>
