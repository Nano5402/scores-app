  ...
  return (
    <div className="space-y-6 animate-fade-up">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold" style={{ color: 'var(--text-primary)' }}>Torneos</h1>
        ...
        <div className="card p-5 animate-fade-up">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="sm:col-span-2">
              <Input label="Nombre *" placeholder="Copa Club Norte 2025"
            ...
            <Input label="Formato" placeholder="Eliminación directa, Round Robin..."
              {...register('formato')} />
            <Input label="Premio" placeholder="Trofeo + $500.000"
              {...register('premio')} />
            <Input label="Cupo máximo" type="number" placeholder="16"
              {...register('cupo_max')} />
        ...
        {loading ? (
          ...
          torneos.map((t, i) => (
            <div key={t.id} className="list-row"
              style={{ borderBottom: i < torneos.length - 1 ? '1px solid var(--border-color)' : 'none' }}>
              ...
              <div className="flex items-center gap-1 shrink-0">
                ...
                <button onClick={() => handleDelete(t)} className="btn-ghost p-2"
                  style={{ color: '#ef4444' }}>
